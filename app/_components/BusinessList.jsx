                ...
                rounded-lg hover:shadow-lg cursor-pointer
                 ...
                 hover:scale-105 transition-all ease-in-out'>
                    ...
                    items-baseline p-3 gap-1'>
                                <h2 className='p-1 rounded-full px-2 text-[12px]' style={{ backgroundColor: business.category?.bgcolor?.hex }}>{business.category?.name}</h2>
                    ...
                    ((
                        <div className='w-full h-[300px]
                            rounded-lg animate-pulse'>No Person
                        </div>
                    ))
                }
            </div>
